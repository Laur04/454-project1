...
getArrVarArith (Var name) = [name]
getArrVarArith (Read _ arithexp) = getArrVarArith arithexp
getArrVarArith (AWrite _ arithexp1 arithexp2) = (getArrVarArith arithexp1) ++ (getArrVarArith arithexp2)
...
getArrVarComp (Eq (AWrite _ _ _) (AWrite _ _ _)) = []
getArrVarComp (Eq (AWrite _ _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Eq arithexp1 (AWrite _ _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Eq (Read _ _) (Read _ _)) = []
getArrVarComp (Eq (Read _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Eq arithexp1 (Read _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Eq arithexp1 arithexp2) = (getArrVarArith arithexp1) ++ (getArrVarArith arithexp2)
getArrVarComp (Neq (AWrite _ _ _) (AWrite _ _ _)) = []
getArrVarComp (Neq (AWrite _ _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Neq arithexp1 (AWrite _ _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Neq (Read _ _) (Read _ _)) = []
getArrVarComp (Neq (Read _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Neq arithexp1 (Read _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Neq arithexp1 arithexp2) = (getArrVarArith arithexp1) ++ (getArrVarArith arithexp2)
getArrVarComp (Le (AWrite _ _ _) (AWrite _ _ _)) = []
getArrVarComp (Le (AWrite _ _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Le arithexp1 (AWrite _ _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Le (Read _ _) (Read _ _)) = []
getArrVarComp (Le (Read _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Le arithexp1 (Read _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Le arithexp1 arithexp2) = (getArrVarArith arithexp1) ++ (getArrVarArith arithexp2)
getArrVarComp (Ge (AWrite _ _ _) (AWrite _ _ _)) = []
getArrVarComp (Ge (AWrite _ _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Ge arithexp1 (AWrite _ _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Ge (Read _ _) (Read _ _)) = []
getArrVarComp (Ge (Read _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Ge arithexp1 (Read _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Ge arithexp1 arithexp2) = (getArrVarArith arithexp1) ++ (getArrVarArith arithexp2)
getArrVarComp (Lt (AWrite _ _ _) (AWrite _ _ _)) = []
getArrVarComp (Lt (AWrite _ _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Lt arithexp1 (AWrite _ _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Lt (Read _ _) (Read _ _)) = []
getArrVarComp (Lt (Read _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Lt arithexp1 (Read _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Lt arithexp1 arithexp2) = (getArrVarArith arithexp1) ++ (getArrVarArith arithexp2)
getArrVarComp (Gt (AWrite _ _ _) (AWrite _ _ _)) = []
getArrVarComp (Gt (AWrite _ _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Gt arithexp1 (AWrite _ _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Gt (Read _ _) (Read _ _)) = []
getArrVarComp (Gt (Read _ _) arithexp2) = (getArrVarArith arithexp2)
getArrVarComp (Gt arithexp1 (Read _ _)) = (getArrVarArith arithexp1)
getArrVarComp (Gt arithexp1 arithexp2) = (getArrVarArith arithexp1) ++ (getArrVarArith arithexp2)
-- getArrVarComp (Eq arithexp1 arithexp2) = (getArrVarArith arithexp1) ++ (getArrVarArith arithexp2)
-- getArrVarComp (Neq arithexp1 arithexp2) = (getArrVarArith arithexp1) ++ (getArrVarArith arithexp2)
-- getArrVarComp (Le arithexp1 arithexp2) = (getArrVarArith arithexp1) ++ (getArrVarArith arithexp2)
-- getArrVarComp (Ge arithexp1 arithexp2) = (getArrVarArith arithexp1) ++ (getArrVarArith arithexp2)
